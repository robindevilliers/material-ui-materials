<form action="${action}" method="post" enctype="application/x-www-form-urlencoded" class="register-panel-widget">
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <#if errors.username??>
                <span class="error-message form-text text-danger">${errors.username}</span>
            <#else>
        ...
        <div class="form-group col">
            ...
            <#if errors.title??>
                <span class="error-message form-text text-danger">${errors.title}</span>
            <#else>
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <#if errors.firstName??>
                <span class="error-message form-text text-danger">${errors.firstName}</span>
            <#else>
        ...
        <div class="form-group col">
            ...
            <#if errors.lastName??>
                <span class="error-message form-text text-danger">${errors.lastName}</span>
            <#else>
    ...
    <div class="row">
        ...
        <div class="form-group col">
            ...
            <#if errors.contactNumber??>
                <span class="error-message form-text text-danger">${errors.contactNumber}</span>
            <#else>
    ...
    <div class="row">
        <div class="form-group col">
            ...
            <#if errors.dateOfBirth??>
                <span class="error-message form-text text-danger">${errors.dateOfBirth}</span>
            <#else>
        ...
        <div class="form-group col">
            ...
            <#if errors.timezone??>
                <span class="error-message form-text text-danger">${errors.timezone}</span>
            <#else>
