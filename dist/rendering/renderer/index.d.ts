...
export declare function findBinder(name: string): TitleRenderer | ParagraphRenderer | DivRenderer | LoginPanelRenderer | WellRenderer | UserExplorerRenderer | ImageRenderer | LinkRenderer | BackLinkRenderer | RegisterPanelRenderer | PageRenderer | ResetPasswordRequestPanelRenderer | ResetPasswordPanelRenderer | AccordionItemHeaderRenderer | InsetTextRenderer | AccordionItemRenderer | WarningRenderer | ColumnRenderer | RowRenderer | CellRenderer | TableRenderer | BadgeRenderer | AccordionRenderer | CardHeaderRenderer | CardBodyRenderer | CardFooterRenderer | CardRenderer | IconRenderer | ToolTipRenderer | ListItemBinder | ListRenderer | CookieConsentRenderer | FakeStoreBinderRenderer | ErrorSummaryRenderer | InputRenderer | EnumerationInputRenderer | ValueRenderer | ScaleRenderer | ButtonRenderer | JumbotronRenderer | CarouselRenderer | CarouselPanelRenderer | ProgressBarRenderer | FormRenderer | WizardTestResultsRenderer | ConfirmWorkflowPanelRenderer | CloseWorkflowExecutedPanelRenderer | FakeUserRenderer | FakeMessageRenderer | FakeWizardRenderer | FakeWorkflowRenderer | FakePageRenderer | FakeQueueBinder | FakeGroupBinder | MileStoneRenderer | HorizontalRuleRenderer | InitiateWorkflowButtonRenderer | MenuRenderer | MenuBrandBinder | MenuItemBinder | SubMenuRenderer | SubMenuLabelBinder | TrayRenderer | TrayHeaderBinder | MessageExplorerRenderer | NotificationBannerRenderer | EmailRenderer | EmailConfirmationLinkRenderer | PasswordResetLinkRenderer | ConfirmationPanelRenderer | BrRenderer | SpanRenderer | UuidRenderer | ScriptBinder | LoopRenderer | SwitchRenderer | undefined;
