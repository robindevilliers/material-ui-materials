    ...
    <div class="font-picker-select col col-12 col-lg-6">
        ...
        <div id="title-primary" class="font-line">
            ...
            <div class="input-group dropright">
                <button class="form-control border btn dropdown-toggle font-package" type="button"
                ...
                <input id="font-size" class="form-control border font-size" type="number" value="1"
                        min="0.5" max="4" step="0.25"/>

                <button class="form-control border btn text-decoration" type="button">
                ...
                <button class="form-control border btn font-style" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <button class="form-control border btn font-weight" type="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
